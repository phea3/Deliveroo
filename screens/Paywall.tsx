    ...
    return (
        <SafeAreaView className='bg-[#1A2F44] flex-1'>
            ...
            <TouchableOpacity
                ...
                <Ionicons name="md-close-circle-sharp" size={32} color="#E5972D" />
            </TouchableOpacity>
            ...
            <View className="space-y-5 px-10 py-5">
                ...
                <View className="flex-row space-x-10 items-center">
                    ...
                    <View className='flex-1'>
                        ...
                        <Text className='text-white text-sm font-extralight'>
                            ...
                            and enjoy all the exclusive features available only to pro users.{" "}
                        </Text>
                    </View>
                </View>
                ...
                <View className="flex-row space-x-10 items-center">
                    ...
                    <View className='flex-1'>
                        ...
                        <Text className='text-white text-sm font-extralight'>
                            Get unlimited access to our fitness support team and
                ...
                <View className="flex-row space-x-10 items-center">
                    ...
                    <View className='flex-1'>
                        ...
                        <Text className='text-white text-sm font-extralight'>
                            Unlock exclusive content that you can't get anyshere else, like special exclusive workouts and routines.{" "}
                        </Text>
                    </View>
                </View>
            </View>
